...
|----------|----------|-------------|
| `pl_historical_load` | Once (manual) | Runs `02-historical-data-load.ipynb` |
...
| `pl_maintenance` | Daily 3 AM UTC | Runs `05-maintain-delta-tables.ipynb` |
...
|----------|----------|----------|
| `pl_demand_forecast` | Daily 6 AM UTC | `06-ml-demand-forecast.ipynb` |
| `pl_market_basket` | Weekly Sun 1 AM UTC | `07-ml-market-basket.ipynb` |
| `pl_customer_segmentation` | Weekly Sun 2 AM UTC | `08-ml-customer-segmentation.ipynb` |
| `pl_churn_prediction` | Weekly Sun 3 AM UTC | `09-ml-churn-prediction.ipynb` |
| `pl_promotion_effectiveness` | Weekly Sun 4 AM UTC | `10-ml-promotion-effectiveness.ipynb` |
| `pl_journey_analysis` | Daily 4 AM UTC | `11-ml-journey-analysis.ipynb` |
| `pl_stockout_prediction` | Daily 5 AM UTC | `12-ml-stockout-prediction.ipynb` |
