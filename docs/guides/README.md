...
Guides explain how to use the current repository. They are derived from the
canonical requirements, specifications, architecture, and security owners and
must link to those owners rather than redefine contracts.
