...
| `SEC-010` | `implemented` | Publish only reviewed canonical Markdown from `docs/`; exclude temporary plans and generated output. | `zensical.toml`; `.github/workflows/docs.yml` | Successful Zensical build and inspection of `gh-pages`. |
