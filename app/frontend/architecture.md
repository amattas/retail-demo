...
> Eventhouse, semantic model), see the project documentation site. This page is the
...
project documentation site (Fabric → Data Agents) for the `.vscode/mcp.json` setup.
...
For the presenter's click-path, see the [CIO Walkthrough](/walkthrough.html).
