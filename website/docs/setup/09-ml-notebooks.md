...
| `07-ml-market-basket.ipynb` | FP-Growth | Weekly | `product_associations`, `product_recommendations` |
...
SHOW TABLES IN au;
-- Should now include the ML output tables alongside the 9 aggregation tables
