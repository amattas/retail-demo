...
> Eventhouse, semantic model), see [Architecture](./index.md). This page is the
...
[Data Agents](../fabric/data-agents.md) reference for the `.vscode/mcp.json` setup.
...
For the presenter's click-path, see the [CIO Walkthrough](../demos/cio-walkthrough.md).
